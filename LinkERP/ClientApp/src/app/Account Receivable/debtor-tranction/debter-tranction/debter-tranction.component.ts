...
@Component({
  selector: 'app-debter-tranction',
  templateUrl: './debter-tranction.component.html',
  styleUrls: ['./debter-tranction.component.css']
})
export class DebterTranctionComponent implements OnInit {
  ...
  BindDebterByID() {
   ...
   this.RowData = [];
    this.debtorservice.GetDebtorDebitTranctionByID(this.DebtorID).subscribe((resp: any) => {
      console.log(resp);
      debugger;
      ...
      this.DebtorDebitTranction=resp.data.debtorTranctionbyId;
      console.log(this.DebtorDebitTranction);
      this.Loading = false;
      this.AgLoad = true;
